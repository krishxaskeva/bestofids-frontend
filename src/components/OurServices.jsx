  ...
  return (
    <>
      ...
      <Section
        ...
        bottomLg={10}
        bottomXl={8}
        className="cs_our_services_teal_section"
      >
        <div className="cs_our_services_teal_intro">
          <div className="container">
            <div className="cs_our_services_teal_row">
              ...
              <div className="cs_our_services_teal_col_right">
      ...
      <Section
        ...
        bottomLg={10}
        bottomXl={8}
        className="cs_our_services_white_section"
      >
      ...
      <Section
        ...
        bottomLg={20}
        bottomXl={16}
        className="cs_shape_wrap cs_our_services_detail_wrap"
      >
