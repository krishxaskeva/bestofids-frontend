...
export default function InquiryModal({ isOpen, onClose, title, type }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setStatus(null);
    try {
      console.log('Sending contact inquiry, type:', type);
      ...
      console.error('Component error (InquiryModal):', err.response?.data || err.message);
      setStatus('error');
    } finally {
      setSubmitting(false);
    }
    ...
    >
      ...
      <div className="cs_contact_modal_content">
        <div className="cs_contact_modal_container">
          ...
          <div className="cs_contact_modal_header_divider" aria-hidden />
          {status === 'success' ? null : (
            <>
              {status === 'error' && (
              ...
              <form onSubmit={handleSubmit} className="cs_contact_form cs_contact_form_inquiry cs_style_1 cs_white_bg cs_radius_30">
                <div className="row cs_contact_form_inquiry_fields">
                  <div className="col-12 col-sm-6">
                    <label className="cs_input_label cs_heading_color" htmlFor="cs_inquiry_name">Name</label>
                    <input
                      id="cs_inquiry_name"
                      type="text"
                  ...
                  <div className="col-12 col-sm-6">
                    <label className="cs_input_label cs_heading_color" htmlFor="cs_inquiry_email">Email</label>
                    <input
                      id="cs_inquiry_email"
                      type="email"
                      className="cs_form_field"
                  ...
                  <div className="col-12">
                    ...
                    <textarea
                      id="cs_inquiry_message"
                      cols={30}
                      rows={4}
                      className="cs_form_field cs_contact_form_inquiry_textarea"
                ...
                <div className="cs_contact_modal_submit_divider" aria-hidden />
