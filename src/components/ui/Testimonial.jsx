      ...
      <ul className="cs_tab_links">
        <li className={activeTab === 1 ? 'active' : ''}>
          <div className="cs_tab_link_in" onClick={() => handleTabClick(1)}>
            <div className="cs_testimonial_1_avatar">
              <img src={getAssetUrl('/images/home_1/avatar_1.png')} alt="Avatar" />
        ...
        <li className={activeTab === 2 ? 'active' : ''}>
          <div className="cs_tab_link_in" onClick={() => handleTabClick(2)}>
            <div className="cs_testimonial_1_avatar">
              <img src={getAssetUrl('/images/home_1/avatar_2.png')} alt="Avatar" />
              <div className="cs_testimonial_1_avatar_right">
        ...
        <li className={activeTab === 3 ? 'active' : ''}>
          <div className="cs_tab_link_in" onClick={() => handleTabClick(3)}>
            <div className="cs_testimonial_1_avatar">
              <img src={getAssetUrl('/images/home_1/avatar_3.png')} alt="Avatar" />
              <div className="cs_testimonial_1_avatar_right">
      ...
      <div className="cs_tab_body">
        {activeTab === 1 && (
          <div className="cs_testimonial cs_style_1">
            <img src={getAssetUrl('/images/icons/quote.svg')} alt="Icon" />
            <p>
              I recently had to bring my child to Best of IDs for a minor injury,
        ...
        {activeTab === 2 && (
          <div className="cs_testimonial cs_style_1">
            ...
            <p>
              ...
              my child to Best of IDs for a minor injury, and I was so impressed
        ...
        {activeTab === 3 && (
          <div className="cs_testimonial cs_style_1">
            ...
            <p>
              ...
              kind and attentive I recently had to bring my child to Best of IDs
